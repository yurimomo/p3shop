...
Devise.setup do |config|
   ...
   if Rails.env.production?
    ...
    config.omniauth :twitter, ENV["TWITTER_ID_PRODUCTION"], ENV["TWITTER_SECRET_PRODUCTION"], scope: 'email', display: 'popup', info_fields: 'name, email',callback_url: "https://agile-refuge-54600.herokuapp.com/callbacks"
  else
  ...
  # config.pepper = 'a22aa2f334e8e33251416d0e5a6d7f6b59d2b0fadb685b3c730e8e63a93fa93b03fbbb1d41cbb6437020072b449e51ccbc5ab21c4c9d056328a55a5949283d96'
