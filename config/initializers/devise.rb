...
Devise.setup do |config|
   ...
   if Rails.env.production?
    ...
    config.omniauth :twitter, ENV["TWITTER_ID_PRODUCTION"], ENV["TWITTER_SECRET_PRODUCTION"], scope: 'email', display: 'popup', info_fields: 'name, email',callback_url: "http://127.0.0.1:3000/users/auth/twitter/callback"
  else
